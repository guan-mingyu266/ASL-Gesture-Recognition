...
class Model(torch.nn.Module):
    ...
    def is_triton_model(model: str) -> bool:
        ...
        This static method determines whether the provided model string represents a val Triton Server URL by parsing
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Args:
            event (str): The name of the event to attach the callback to. Must be a val event name recognized by the
